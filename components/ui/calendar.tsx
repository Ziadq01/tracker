  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        nav_button:
          "h-[44px] w-[44px] md:h-6 md:w-6 inline-flex items-center justify-center text-secondary hover:text-foreground transition-colors",
        nav_button_previous: "absolute left-0",
        nav_button_next: "absolute right-0",
        table: "w-full border-collapse",
        head_row: "flex",
        head_cell:
          "w-[42px] md:w-8 text-2xs font-normal uppercase tracking-header text-secondary",
        ...
        day: cn(
          // 40px on touch, back to the compact 32px grid from md up.
          "h-[42px] w-[42px] md:h-8 md:w-8 p-0 font-normal text-foreground rounded-md transition-colors",
